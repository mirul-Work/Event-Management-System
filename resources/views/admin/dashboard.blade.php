...
@section('content-dashboard')
    ...
    <div class="container py-6">
        <h3 class="mb-6 text-2xl font-semibold">Admin Dashboard</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="card text-white bg-blue-600 rounded-lg shadow-lg">
                <div class="card-body p-6">
                    ...
                    <a href="{{ route('admin.profile') }}" class="mt-4 inline-block px-4 py-2 bg-white text-blue-600 rounded-lg">Manage Profile</a>
                </div>
            </div>
            ...
            <div class="card text-white bg-yellow-500 rounded-lg shadow-lg">
                <div class="card-body p-6">
                    <h5 class="text-xl font-semibold">Total Organizer: {{ $users->count() }}</h5>
                    <p class="text-sm mt-2">Go to Organizers</p>
                    <a href="{{ route('admin.organizers.index') }}" class="mt-4 inline-block px-4 py-2 bg-white text-yellow-600 rounded-lg">Manage Organizers</a>
                </div>
            </div>
            ...
            <div class="card text-white bg-green-600 rounded-lg shadow-lg">
                <div class="card-body p-6">
                    ...
                    <a href="{{ route('admin.events.index') }}" class="mt-4 inline-block px-4 py-2 bg-white text-green-600 rounded-lg">Manage Events</a>
                </div>
            </div>
        </div>
    </div>
