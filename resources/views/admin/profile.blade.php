...
@section('content-dashboard')
    ...
    @endif
    <form action="{{ route('admin.profile.update') }}" method="POST" class="max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-md">
        @csrf
        ...
        <button type="submit" class="btn btn-primary mt-4 bg-indigo-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Update Profile</button>
    </form>
@endsection
