...
<body class="bg-gray-100">
    <div class="d-flex">
        ...
        <aside class="sidebar bg-white shadow-md w-64">
            <div class="p-4">
                <h5 class="text-center text-lg font-semibold text-amber-500">Admin</h5>
                @yield('role')
                <hr class="my-2">
                @yield('side-bar-ul')
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        class="nav-link {{ request()->routeIs('admin.profile') ? 'active' : '' }}">Profile</a>

                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.organizers.index') }}"
                        class="nav-link {{ request()->routeIs('admin.organizers.index') ? 'active' : '' }}">Organizers</a>

                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.events.index') }}"
                        class="nav-link {{ request()->routeIs('admin.events.index') ? 'active' : '' }}">Events</a>
                ...
                <nav class="navbar bg-white border-b-2">
                    <div class="container mx-auto flex items-center justify-between px-4">
                        ...
                        <div class="flex items-center">
                            <button class="btn btn-outline-warnin md:hidden" id="toggleSidebarMobile">
                                ☰
                            </button>
    ...
    <footer class="bg-gray-800 text-white text-center py-3 fixed bottom-0 w-full">
        <i class="fa fa-copyright" aria-hidden="true"> 2025 Event Management System Copyright</i>
    </footer> --}}
